  ...
  void getToken() {
    ...
    if (code == charCodes.$SQ || code == charCodes.$DQ) {
      ...
      do {
        ...
        newCat =
            (code == charCodes.$BANG || code == charCodes.$SLASH) ? NONE : category(code);
      } while (!singleCharCategory(cat) &&
          (cat == newCat || (cat == ALPHA && newCat == NUMERIC) || // eg. level42.
  ...
  Expression parseFunctionExpression() {
    ...
    if (acceptCategory(ALPHA)) {
      ...
      return new NamedFunction(
          new VariableDeclaration(functionName),
          parseFun());
    }
    return parseFun();
  }
      ...
      if (acceptString('in')) {
        ...
        return new ForIn(
            new VariableDeclarationList(
                [new VariableInitialization(new VariableDeclaration(identifier), null)]),
            objectExpression,
            body);
      }
