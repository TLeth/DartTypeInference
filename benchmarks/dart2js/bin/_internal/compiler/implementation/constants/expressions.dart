...
abstract class ConstantExpression {
  ...
  String toString() {
    assertDebugMode(
        'Use ConstantExpression.getText() instead of ' 'ConstantExpression.toString()');
    return getText();
  }
}
...
class ConstructedConstantExpresssion extends ConstantExpression {
  ...
  ConstructedConstantExpresssion(this.value, this.type, this.target,
      this.selector, this.arguments) {
...
class ConditionalConstantExpression extends ConstantExpression {
  ...
  ConditionalConstantExpression(this.value, this.condition, this.trueExp,
      this.falseExp);
...
class ConstExpPrinter extends ConstantExpressionVisitor {
  ...
  write(ConstantExpression parent, ConstantExpression child,
