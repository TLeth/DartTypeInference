...
import '../../../js_lib/shared/embedded_names.dart' show DEFERRED_LIBRARY_URIS,
    DEFERRED_LIBRARY_HASHES, INITIALIZE_LOADED_HUNK, IS_HUNK_LOADED;
...
class ModelEmitter {
  ...
  js.Statement emitMainUnit(MainOutput unit, Map<String,
      List<Output>> loadMap) {
  ...
  js.Block emitHolders(List<Holder> holders) {
    ...
    List<js.Statement> statements = [
        ...
        js.js.statement(
            'var holders = #',
            new js.ArrayInitializer.from(holders.map((e) => new js.VariableUse(e.name))))];
  ...
  List<js.Property> emitLoadUrisAndHashes(Map<String, List<Output>> loadMap) {
    js.ArrayInitializer outputUris(List<Output> outputs) {
      return js.stringArray(
          outputs.map(
              (DeferredOutput output) => "${output.outputFileName}$deferredExtension"));
    }
    ...
    return <js.Property>[
        new js.Property(
            js.string(DEFERRED_LIBRARY_URIS),
            new js.ObjectInitializer(uris)),
        new js.Property(
            js.string(DEFERRED_LIBRARY_HASHES),
  ...
  js.Expression emitLibrary(Library library) {
    Iterable staticDescriptors = library.statics.expand(
        (e) => [js.string(e.name), js.number(e.holder.index), emitStaticMethod(e)]);
    Iterable classDescriptors = library.classes.expand(
        (e) => [js.string(e.name), js.number(e.holder.index), emitClass(e)]);
