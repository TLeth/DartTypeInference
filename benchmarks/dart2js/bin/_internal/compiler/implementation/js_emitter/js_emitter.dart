...
import '../closure.dart' show ClosureClassElement, ClosureClassMap,
    ClosureFieldElement, CapturedVariable;

import '../dart_types.dart' show TypedefType;

import '../dart2jslib.dart' show CodeBuffer;

import '../elements/elements.dart' show ConstructorBodyElement, ElementKind,
    ParameterElement, TypeVariableElement;
...
import '../js_backend/js_backend.dart' show CheckedModeHelper, ConstantEmitter,
    CustomElementsAnalysis, JavaScriptBackend, JavaScriptConstantCompiler, Namer,
    NativeEmitter, RuntimeTypes, Substitution, TypeCheck, TypeChecks,
    TypeVariableHandler;
