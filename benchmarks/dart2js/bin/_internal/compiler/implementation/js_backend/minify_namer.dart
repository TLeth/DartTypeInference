...
class MinifyNamer extends Namer {
  ...
  void reserveBackendNames() {
    ...
    _populateSuggestedNames(
        ...
        const <String>[
            ...
            r'$index',
            r'$indexSet',
            r'$isJavaScriptIndexingBehavior',
            r'$xor',
            r'iterator',
            r'length',
            r'$lt',
    ...
    _populateSuggestedNames(
        ...
        const <String>[
            ...
            r'length',
            r'$sub',
            r'getInterceptor$JSArrayJSString',
            r'$add',
            r'$gt',
            r'$ge',
            r'$lt',
            r'$le',
            r'add',
            r'getInterceptor$JSNumber',
            r'iterator',
            r'$index',
            r'iae',
            r'getInterceptor$JSArray',
            r'ArgumentError$',
            r'BoundClosure',
            r'StateError$',
            r'getInterceptor',
  ...
  void _populateSuggestedNames(Map<String, String> suggestionMap,
      Set<String> used, List<String> suggestions) {
    int c = $a - 1;
    String letter;
