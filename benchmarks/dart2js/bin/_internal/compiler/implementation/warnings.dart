...
class MessageKind {
  ...
  static const MessageKind NOT_ASSIGNABLE =
      const MessageKind("'#{fromType}' is not assignable to '#{toType}'.");

  static const MessageKind VOID_EXPRESSION =
      const MessageKind("Expression does not yield a value.");

  static const MessageKind VOID_VARIABLE =
      const MessageKind("Variable cannot be of type void.");

  static const MessageKind RETURN_VALUE_IN_VOID =
      const MessageKind("Cannot return value from void function.");

  static const MessageKind RETURN_NOTHING =
      const MessageKind("Value of type '#{returnType}' expected.");

  static const MessageKind MISSING_ARGUMENT =
      const MessageKind("Missing argument of type '#{argumentType}'.");

  static const MessageKind ADDITIONAL_ARGUMENT =
      const MessageKind("Additional argument.");

  static const MessageKind NAMED_ARGUMENT_NOT_FOUND =
      const MessageKind("No named argument '#{argumentName}' found on method.");

  static const MessageKind MEMBER_NOT_FOUND =
      const MessageKind("No member named '#{memberName}' in class '#{className}'.");

  static const MessageKind METHOD_NOT_FOUND =
      const MessageKind("No method named '#{memberName}' in class '#{className}'.");

  static const MessageKind OPERATOR_NOT_FOUND =
      const MessageKind("No operator '#{memberName}' in class '#{className}'.");

  static const MessageKind SETTER_NOT_FOUND =
      const MessageKind("No setter named '#{memberName}' in class '#{className}'.");

  static const MessageKind GETTER_NOT_FOUND =
      const MessageKind("No getter named '#{memberName}' in class '#{className}'.");

  static const MessageKind NOT_CALLABLE =
      const MessageKind("'#{elementName}' is not callable.");

  static const MessageKind MEMBER_NOT_STATIC =
      const MessageKind("'#{className}.#{memberName}' is not static.");

  static const MessageKind NO_INSTANCE_AVAILABLE =
      const MessageKind("'#{name}' is only available in instance methods.");

  static const MessageKind PRIVATE_ACCESS = const MessageKind(
      "'#{name}' is declared private within library " "'#{libraryName}'.");

  static const MessageKind THIS_IS_THE_DECLARATION =
      const MessageKind("This is the declaration of '#{name}'.");

  static const MessageKind THIS_IS_THE_METHOD =
      const MessageKind("This is the method declaration.");

  static const MessageKind CANNOT_RESOLVE =
...
"""]);
  ...
  static const MessageKind INVALID_CONSTRUCTOR_NAME =
      const MessageKind("Constructor name must start with '#{name}'.");
  ...
  static const MessageKind DUPLICATE_IMPORT =
      const MessageKind("Duplicate import of '#{name}'.");
...
class Future {}"""
  ...
  static const MessageKind HIDDEN_IMPLICIT_IMPORT = const MessageKind(
      "'#{name}' from library '#{hiddenUri}' is hidden by '#{name}' "
          "from library '#{hidingUri}'.",
      howToFix: "Try adding an explicit " "'import \"#{hiddenUri}\" hide #{name}'.",
      examples: const [const {
      'main.dart': """
...
main() {}""",
  ...
  static const MessageKind NOT_A_TYPE =
      const MessageKind("'#{node}' is not a type.");

  static const MessageKind NOT_A_PREFIX =
      const MessageKind("'#{node}' is not a prefix.");

  static const MessageKind CANNOT_FIND_CONSTRUCTOR =
      const MessageKind("Cannot find constructor '#{constructorName}'.");

  static const MessageKind CYCLIC_CLASS_HIERARCHY =
      const MessageKind("'#{className}' creates a cycle in the class hierarchy.");

  static const MessageKind CYCLIC_REDIRECTING_FACTORY =
      const MessageKind('Redirecting factory leads to a cyclic redirection.');

  static const MessageKind INVALID_RECEIVER_IN_INITIALIZER =
      const MessageKind("Field initializer expected.");

  static const MessageKind NO_SUPER_IN_STATIC =
      const MessageKind("'super' is only available in instance methods.");

  static const MessageKind DUPLICATE_INITIALIZER =
      const MessageKind("Field '#{fieldName}' is initialized more than once.");

  static const MessageKind ALREADY_INITIALIZED =
      const MessageKind("'#{fieldName}' was already initialized here.");

  static const MessageKind INIT_STATIC_FIELD =
      const MessageKind("Cannot initialize static field '#{fieldName}'.");

  static const MessageKind NOT_A_FIELD =
      const MessageKind("'#{fieldName}' is not a field.");

  static const MessageKind CONSTRUCTOR_CALL_EXPECTED =
      const MessageKind("only call to 'this' or 'super' constructor allowed.");

  static const MessageKind INVALID_FOR_IN =
      const MessageKind("Invalid for-in variable declaration.");

  static const MessageKind INVALID_INITIALIZER =
      const MessageKind("Invalid initializer.");

  static const MessageKind FUNCTION_WITH_INITIALIZER =
      const MessageKind("Only constructors can have initializers.");

  static const MessageKind REDIRECTING_CONSTRUCTOR_CYCLE =
      const MessageKind("Cyclic constructor redirection.");
...
main() => new C();"""]);
  ...
  static const MessageKind REDIRECTING_CONSTRUCTOR_HAS_INITIALIZER =
      const MessageKind("Redirecting constructor cannot have other initializers.");

  static const MessageKind SUPER_INITIALIZER_IN_OBJECT =
      const MessageKind("'Object' cannot have a super initializer.");

  static const MessageKind DUPLICATE_SUPER_INITIALIZER =
      const MessageKind("Cannot have more than one super initializer.");
  ...
  static const MessageKind NO_MATCHING_CONSTRUCTOR_FOR_IMPLICIT =
      const MessageKind(
          "Implicit 'super' call arguments and constructor parameters " "do not match.");

  static const MessageKind CONST_CALLS_NON_CONST =
      const MessageKind("'const' constructor cannot call a non-const constructor.");
...
main() => new C(0);"""]);
  ...
  static const MessageKind CONST_CONSTRUCTOR_WITH_NONFINAL_FIELDS_FIELD =
      const MessageKind("This non-final field prevents using const " "constructors.");

  static const MessageKind CONST_CONSTRUCTOR_WITH_NONFINAL_FIELDS_CONSTRUCTOR =
      const MessageKind(
          "This const constructor is not allowed due to " "non-final fields.");


  static const MessageKind INITIALIZING_FORMAL_NOT_ALLOWED = const MessageKind(
      "Initializing formal parameter only allowed in generative " "constructor.");

  static const MessageKind INVALID_PARAMETER =
      const MessageKind("Cannot resolve parameter.");

  static const MessageKind NOT_INSTANCE_FIELD =
      const MessageKind("'#{fieldName}' is not an instance field.");

  static const MessageKind NO_CATCH_NOR_FINALLY =
      const MessageKind("Expected 'catch' or 'finally'.");

  static const MessageKind EMPTY_CATCH_DECLARATION =
      const MessageKind("Expected an identifier in catch declaration.");

  static const MessageKind EXTRA_CATCH_DECLARATION =
      const MessageKind("Extra parameter in catch declaration.");

  static const MessageKind PARAMETER_WITH_TYPE_IN_CATCH =
      const MessageKind("Cannot use type annotations in catch.");

  static const MessageKind PARAMETER_WITH_MODIFIER_IN_CATCH =
      const MessageKind("Cannot use modifiers in catch.");
  ...
  static const MessageKind NO_BREAK_TARGET =
      const MessageKind("'break' statement not inside switch or loop.");

  static const MessageKind NO_CONTINUE_TARGET =
      const MessageKind("'continue' statement not inside loop.");

  static const MessageKind EXISTING_LABEL =
      const MessageKind("Original declaration of duplicate label '#{labelName}'.");

  static const MessageKind DUPLICATE_LABEL =
      const MessageKind("Duplicate declaration of label '#{labelName}'.");

  static const MessageKind UNUSED_LABEL =
      const MessageKind("Unused label '#{labelName}'.");

  static const MessageKind INVALID_CONTINUE =
      const MessageKind("Target of continue is not a loop or switch case.");

  static const MessageKind INVALID_BREAK =
      const MessageKind("Target of break is not a statement.");

  static const MessageKind DUPLICATE_TYPE_VARIABLE_NAME =
      const MessageKind("Type variable '#{typeVariableName}' already declared.");
...
"""]);
  ...
  static const MessageKind INVALID_CASE_DEFAULT =
      const MessageKind("'default' only allowed on last case of a switch.");

  static const MessageKind SWITCH_CASE_TYPES_NOT_EQUAL =
      const MessageKind("'case' expressions do not all have type '#{type}'.");

  static const MessageKind SWITCH_CASE_TYPES_NOT_EQUAL_CASE =
      const MessageKind("'case' expression of type '#{type}'.");

  static const MessageKind SWITCH_CASE_FORBIDDEN =
      const MessageKind("'case' expression may not be of type '#{type}'.");

  static const MessageKind SWITCH_CASE_VALUE_OVERRIDES_EQUALS =
      const MessageKind("'case' expression type '#{type}' overrides 'operator =='.");

  static const MessageKind INVALID_ARGUMENT_AFTER_NAMED =
      const MessageKind("Unnamed argument after named argument.");

  static const MessageKind NOT_A_COMPILE_TIME_CONSTANT =
      const MessageKind("Not a compile-time constant.");
  ...
  static const MessageKind DEFERRED_COMPILE_TIME_CONSTANT_CONSTRUCTION =
      const MessageKind(
          "A deferred class cannot be used to create a" "compile-time constant.");

  static const MessageKind CYCLIC_COMPILE_TIME_CONSTANTS =
      const MessageKind("Cycle in the compile-time constant computation.");

  static const MessageKind CONSTRUCTOR_IS_NOT_CONST =
      const MessageKind("Constructor is not a 'const' constructor.");

  static const MessageKind CONST_MAP_KEY_OVERRIDES_EQUALS =
      const MessageKind("Const-map key type '#{type}' overrides 'operator =='.");

  static const MessageKind NO_SUCH_LIBRARY_MEMBER =
      const MessageKind("'#{libraryName}' has no member named '#{memberName}'.");

  static const MessageKind CANNOT_INSTANTIATE_TYPEDEF =
      const MessageKind("Cannot instantiate typedef '#{typedefName}'.");
...
main() {
  ...
  static const MessageKind NAMED_PARAMETER_WITH_EQUALS = const MessageKind(
      "Named optional parameters can't use '=' to specify a default " "value.",
...
"""]);
  ...
  static const MessageKind CANNOT_INSTANTIATE_TYPE_VARIABLE =
      const MessageKind("Cannot instantiate type variable '#{typeVariableName}'.");
...
main() { F f = null; }"""]);
  ...
  static const MessageKind CANNOT_EXTEND =
      const MessageKind("'#{type}' cannot be extended.");

  static const MessageKind CANNOT_IMPLEMENT =
      const MessageKind("'#{type}' cannot be implemented.");
...
"""]);
  ...
  static const MessageKind DUPLICATE_IMPLEMENTS = const MessageKind(
      "'#{type}' must not occur more than once " "in the implements clause.");
  ...
  static const MessageKind ILLEGAL_SUPER_SEND =
      const MessageKind("'#{name}' cannot be called on super.");

  static const MessageKind NO_SUCH_SUPER_MEMBER = const MessageKind(
      "Cannot resolve '#{memberName}' in a superclass of '#{className}'.");

  static const MessageKind ADDITIONAL_TYPE_ARGUMENT =
      const MessageKind("Additional type argument.");

  static const MessageKind MISSING_TYPE_ARGUMENT =
      const MessageKind("Missing type argument.");

  // TODO(johnniwinther): Use ADDITIONAL_TYPE_ARGUMENT or MISSING_TYPE_ARGUMENT
  // instead.
  static const MessageKind TYPE_ARGUMENT_COUNT_MISMATCH =
      const MessageKind("Incorrect number of type arguments on '#{type}'.");

  static const MessageKind GETTER_MISMATCH =
      const MessageKind("Setter disagrees on: '#{modifiers}'.");

  static const MessageKind SETTER_MISMATCH =
      const MessageKind("Getter disagrees on: '#{modifiers}'.");

  static const MessageKind ILLEGAL_SETTER_FORMALS =
      const MessageKind("A setter must have exactly one argument.");
  ...
  static const MessageKind NO_STATIC_OVERRIDE_CONT = const MessageKind(
      "This is the instance member that cannot be overridden " "by a static member.");
  ...
  static const MessageKind INVALID_OVERRIDDEN_METHOD = const MessageKind(
      "This is the overridden method '#{name}' declared in class " "'#{class}'.");
  ...
  static const MessageKind INVALID_OVERRIDDEN_GETTER = const MessageKind(
      "This is the overridden getter '#{name}' declared in class " "'#{class}'.");
  ...
  static const MessageKind INVALID_OVERRIDDEN_SETTER = const MessageKind(
      "This is the overridden setter '#{name}' declared in class " "'#{class}'.");
  ...
  static const MessageKind INVALID_OVERRIDDEN_FIELD = const MessageKind(
      "This is the overridden field '#{name}' declared in class " "'#{class}'.");
  ...
  static const MessageKind CANNOT_OVERRIDE_FIELD_WITH_METHOD_CONT =
      const MessageKind("This is the field that cannot be overridden by a method.");
  ...
  static const MessageKind CANNOT_OVERRIDE_METHOD_WITH_FIELD_CONT =
      const MessageKind("This is the method that cannot be overridden by a field.");
  ...
  static const MessageKind CANNOT_OVERRIDE_GETTER_WITH_METHOD_CONT =
      const MessageKind("This is the getter that cannot be overridden by a method.");
  ...
  static const MessageKind CANNOT_OVERRIDE_METHOD_WITH_GETTER_CONT =
      const MessageKind("This is the method that cannot be overridden by a getter.");

  static const MessageKind MISSING_FORMALS =
      const MessageKind("Formal parameters are missing.");

  static const MessageKind EXTRA_FORMALS =
      const MessageKind("Formal parameters are not allowed here.");

  static const MessageKind UNARY_OPERATOR_BAD_ARITY =
      const MessageKind("Operator '#{operatorName}' must have no parameters.");

  static const MessageKind MINUS_OPERATOR_BAD_ARITY =
      const MessageKind("Operator '-' must have 0 or 1 parameters.");

  static const MessageKind BINARY_OPERATOR_BAD_ARITY =
      const MessageKind("Operator '#{operatorName}' must have exactly 1 parameter.");
  ...
  static const MessageKind OPERATOR_NAMED_PARAMETERS =
      const MessageKind("Operator '#{operatorName}' cannot have named parameters.");
...
main() => new C();"""]);
  ...
  static const MessageKind ILLEGAL_MIXIN_APPLICATION_MODIFIERS =
      const MessageKind("Illegal mixin application modifiers: '#{modifiers}'.");

  static const MessageKind ILLEGAL_MIXIN_SUPERCLASS =
      const MessageKind("Class used as mixin must have Object as superclass.");

  static const MessageKind ILLEGAL_MIXIN_OBJECT =
      const MessageKind("Cannot use Object as mixin.");

  static const MessageKind ILLEGAL_MIXIN_CONSTRUCTOR =
      const MessageKind("Class used as mixin cannot have non-factory constructor.");
  ...
  static const MessageKind ILLEGAL_MIXIN_WITH_SUPER = const MessageKind(
      "Cannot use class '#{className}' as a mixin because it uses " "'super'.");

  static const MessageKind ILLEGAL_MIXIN_SUPER_USE =
      const MessageKind("Use of 'super' in class used as mixin.");

  static const MessageKind PARAMETER_NAME_EXPECTED =
      const MessageKind("parameter name expected.");

  static const MessageKind CANNOT_RESOLVE_GETTER =
      const MessageKind("Cannot resolve getter.");

  static const MessageKind CANNOT_RESOLVE_SETTER =
      const MessageKind("Cannot resolve setter.");
  ...
  static const MessageKind VOID_NOT_ALLOWED = const MessageKind(
      ...
      howToFix: "Try removing 'void' keyword or replace it with 'var', 'final',"
          " or a type.",
      examples: const ["void x; main() {}", "foo(void x) {} main() { foo(null); }",]);

  static const MessageKind NULL_NOT_ALLOWED =
      const MessageKind("`null` can't be used here.");

  static const MessageKind BEFORE_TOP_LEVEL =
      const MessageKind("Part header must come before top-level definitions.");
...
"""
  ...
  static const MessageKind DUPLICATED_PART_OF =
      const MessageKind("Duplicated part-of directive.");

  static const MessageKind ILLEGAL_DIRECTIVE =
      const MessageKind("Directive not allowed here.");
...
Length: #{length}''');
  ...
  static const MessageKind REFERENCE_IN_INITIALIZATION = const MessageKind(
      "Variable '#{variableName}' is referenced during its " "initialization.",
...
"""]);
  ...
  static const MessageKind CONST_WITHOUT_INITIALIZER = const MessageKind(
      ...
      howToFix: "Try adding an initializer or " "removing the 'const' modifier.",
      examples: const ["""
void main() {
  ...
  static const MessageKind FINAL_WITHOUT_INITIALIZER = const MessageKind(
      ...
      howToFix: "Try adding an initializer or " "removing the 'final' modifier.",
      examples: const ["class C { static final field; } main() => C.field;"]);

  static const MessageKind MEMBER_USES_CLASS_NAME = const MessageKind(
      "Member variable can't have the same name as the class it is " "declared in.",
...
"""]);
  ...
  static const MessageKind FACTORY_REDIRECTION_IN_NON_FACTORY =
      const MessageKind("Factory redirection only allowed in factories.");

  static const MessageKind MISSING_FACTORY_KEYWORD =
      const MessageKind("Did you forget a factory keyword here?");

  static const MessageKind DEFERRED_LIBRARY_DART_2_DART = const MessageKind(
      "Deferred loading is not supported by the dart backend yet."
          "The output will not be split.");

  static const MessageKind DEFERRED_LIBRARY_WITHOUT_PREFIX = const MessageKind(
      "This import is deferred but there is no prefix keyword.",
      howToFix: "Try adding a prefix to the import.");

  static const MessageKind DEFERRED_OLD_SYNTAX = const MessageKind(
      "The DeferredLibrary annotation is obsolete.",
      howToFix: "Use the \"import 'lib.dart' deferred as prefix\" syntax instead.");
  ...
  static const MessageKind DEFERRED_TYPE_ANNOTATION = const MessageKind(
  ...
  static const MessageKind ILLEGAL_STATIC = const MessageKind(
      "Modifier static is only allowed on functions declared in " "a class.");

  static const MessageKind STATIC_FUNCTION_BLOAT = const MessageKind(
      "Using '#{class}.#{name}' may lead to unnecessarily large " "generated code.",
      howToFix: "Try adding '@MirrorsUsed(...)' as described at "
          "https://goo.gl/Akrrog.");

  static const MessageKind NON_CONST_BLOAT = const MessageKind(
      "Using 'new #{name}' may lead to unnecessarily large generated " "code.",
      howToFix: "Try using 'const #{name}' or adding '@MirrorsUsed(...)' as "
          "described at https://goo.gl/Akrrog.");

  static const MessageKind STRING_EXPECTED =
      const MessageKind("Expected a 'String', but got an instance of '#{type}'.");

  static const MessageKind PRIVATE_IDENTIFIER = const MessageKind(
      "'#{value}' is not a valid Symbol name because it starts with " "'_'.");
 ...
 * a qualified non-private identifier followed by '.' and a user-defined '''
  ...
  static const MessageKind AMBIGUOUS_REEXPORT =
      const MessageKind("'#{name}' is (re)exported by multiple libraries.");

  static const MessageKind AMBIGUOUS_LOCATION =
      const MessageKind("'#{name}' is defined here.");
  ...
  static const MessageKind OVERRIDE_EQUALS_NOT_HASH_CODE = const MessageKind(
      "The class '#{class}' overrides 'operator==', " "but not 'get hashCode'.");

  static const MessageKind PACKAGE_ROOT_NOT_SET =
      const MessageKind("Cannot resolve '#{uri}'. Package root has not been set.");

  static const MessageKind INTERNAL_LIBRARY_FROM = const MessageKind(
      "Internal library '#{resolvedUri}' is not accessible from "
          "'#{importingUri}'.");

  static const MessageKind INTERNAL_LIBRARY =
      const MessageKind("Internal library '#{resolvedUri}' is not accessible.");
  ...
  static const MessageKind UNSUPPORTED_THROW_WITHOUT_EXP =
      const MessageKind("No expression after 'throw'. " "Did you mean 'rethrow'?");
...
"""]);
  ...
  static const MessageKind EXTRANEOUS_MODIFIER = const MessageKind(
      ...
      examples: const ["var String foo; main(){}", // "var get foo; main(){}",
    "var set foo; main(){}",
        "var final foo; main(){}",
        "var var foo; main(){}",
        "var const foo; main(){}",
  ...
  static const MessageKind MIRROR_IMPORT =
      const MessageKind("Import of 'dart:mirrors'.");
  ...
  static const MessageKind NAMED_FUNCTION_EXPRESSION = const MessageKind(
  ...
  static const MessageKind ABSTRACT_METHOD = const MessageKind(
      "The method '#{name}' has no implementation in " "class '#{class}'.",
...
"""]);
  ...
  static const MessageKind ABSTRACT_GETTER = const MessageKind(
      "The getter '#{name}' has no implementation in " "class '#{class}'.",
      howToFix: "Try adding a body to '#{name}' or declaring "
          "'#{class}' to be 'abstract'.",
      examples: const ["""
class Class {
...
"""]);
  ...
  static const MessageKind ABSTRACT_SETTER = const MessageKind(
      "The setter '#{name}' has no implementation in " "class '#{class}'.",
      howToFix: "Try adding a body to '#{name}' or declaring "
          "'#{class}' to be 'abstract'.",
      examples: const ["""
class Class {
...
"""]);
  ...
  static const MessageKind INHERITED_METHOD = const MessageKind(
      "The inherited method '#{name}' is declared here in class " "'#{class}'.");

  static const MessageKind INHERITED_EXPLICIT_GETTER = const MessageKind(
      "The inherited getter '#{name}' is declared here in class " "'#{class}'.");
  ...
  static const MessageKind UNIMPLEMENTED_METHOD_ONE = const MessageKind(
      "'#{class}' doesn't implement '#{method}' " "declared in '#{declarer}'.",
...
"""]);
  ...
  static const MessageKind UNTERMINATED_TOKEN =
      const MessageKind(// This is a fall-back message that shouldn't happen.
  "Incomplete token.");
...
"""]);
  ...
  static const MessageKind HEX_DIGIT_EXPECTED = const MessageKind(
      ...
      howToFix: DONT_KNOW_HOW_TO_FIX,
      // Seems obvious from the error message.
  examples: const ["""
main() {
  var i = 0x;
}
...
/*"""]);
  ...
  howToFix: DONT_KNOW_HOW_TO_FIX,
      examples: const ["main() => true ? 1;", "main() => foo(x: 1 y: 2);",]);
...
"""]);
  ...
  static const MessageKind MISSING_MAIN = const MessageKind(
      "Could not find '#{main}'.",
      howToFix:
          "Try adding a method named '#{main}' to your program."/* No example, test uses '--analyze-only' which will produce the above
...
''');
  ...
  static const MessageKind POTENTIAL_MUTATION_HERE =
      const MessageKind("Variable '#{variableName}' is potentially mutated here.");
  ...
  static const MessageKind POTENTIAL_MUTATION_IN_CLOSURE_HERE =
      const MessageKind(
          "Variable '#{variableName}' is potentially mutated in a " "closure here.");
  ...
  static const MessageKind ACCESSED_IN_CLOSURE_HERE =
      const MessageKind("Variable '#{variableName}' is accessed in a closure here.");
  ...
  static const MessageKind HIDDEN_WARNINGS =
      const MessageKind("#{warnings} warning(s) suppressed in #{uri}.");

  static const MessageKind HIDDEN_HINTS =
      const MessageKind("#{hints} hint(s) suppressed in #{uri}.");
  ...
  static const MessageKind PATCH_POINT_TO_FUNCTION =
      const MessageKind("This is the function patch '#{functionName}'.");

  static const MessageKind PATCH_POINT_TO_CLASS =
      const MessageKind("This is the class patch '#{className}'.");

  static const MessageKind PATCH_POINT_TO_GETTER =
      const MessageKind("This is the getter patch '#{getterName}'.");

  static const MessageKind PATCH_POINT_TO_SETTER =
      const MessageKind("This is the setter patch '#{setterName}'.");

  static const MessageKind PATCH_POINT_TO_CONSTRUCTOR =
      const MessageKind("This is the constructor patch '#{constructorName}'.");

  static const MessageKind PATCH_POINT_TO_PARAMETER =
      const MessageKind("This is the patch parameter '#{parameterName}'.");

  static const MessageKind PATCH_NON_EXISTING =
      const MessageKind("Origin does not exist for patch '#{name}'.");

  // TODO(ahe): Eventually, this error should be removed as it will be handled
  // by the regular parser.
  static const MessageKind PATCH_NONPATCHABLE =
      const MessageKind("Only classes and functions can be patched.");

  static const MessageKind PATCH_NON_EXTERNAL =
      const MessageKind("Only external functions can be patched.");

  static const MessageKind PATCH_NON_CLASS =
      const MessageKind("Patching non-class with class patch '#{className}'.");

  static const MessageKind PATCH_NON_GETTER =
      const MessageKind("Cannot patch non-getter '#{name}' with getter patch.");

  static const MessageKind PATCH_NO_GETTER =
      const MessageKind("No getter found for getter patch '#{getterName}'.");

  static const MessageKind PATCH_NON_SETTER =
      const MessageKind("Cannot patch non-setter '#{name}' with setter patch.");
  ...
  static const MessageKind PATCH_NON_CONSTRUCTOR = const MessageKind(
      "Cannot patch non-constructor with constructor patch " "'#{constructorName}'.");

  static const MessageKind PATCH_NON_FUNCTION = const MessageKind(
      "Cannot patch non-function with function patch " "'#{functionName}'.");
  ...
  String computeMessage() {
    if (message == null) {
      ...
      assert(invariant(
          ...
          kind == MessageKind.GENERIC || !message.contains(new RegExp(r'#\{.+\}')),
